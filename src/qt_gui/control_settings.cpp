...
std::map<std::string, int> index_map = {
    ...
    {"dpad_down", 12},   {"dpad_left", 13},

    {"dpad_right", 14},

    {"lstickup", 15},

    {"lstickdown", 16},  {"lstickleft", 17},

    {"lstickright", 18},

    {"rstickup", 19},

    {"rstickdown", 20},  {"rstickleft", 21},
...
ControlSettings::ControlSettings(QWidget* parent)
    ...
    connect(ui->LStickSwap, &QCheckBox::stateChanged, this, [](bool val) { Lstickswapmap = val; });
    ...
    connect(ui->RStickSwap, &QCheckBox::stateChanged, this, [](bool val) { Rstickswapmap = val; });
...
void ControlSettings::GetMappings() {
    toml::value data = toml::parse("Controller.toml");
    ...
    LstickinvertXmap = toml::find_or<bool>(data, "Left_analog_stick_behavior",
    ...
    RstickinvertXmap = toml::find_or<bool>(data, "Right_analog_stick_behavior",
                                           "Invert_movement_horizontal", false);
}

void ControlSettings::SetUIValues() {
